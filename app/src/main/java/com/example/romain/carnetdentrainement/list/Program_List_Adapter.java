...
import com.example.romain.carnetdentrainement.vue.ProgrammesActivity;

import java.util.ArrayList;

public class Program_List_Adapter extends BaseAdapter {
    ...
    public Program_List_Adapter(Context contexte, ArrayList<Programme> lesProgrammes){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.txtEntite.setText(lesProgrammes.get(i).getNom());
     ...
     * @param i
     */
    private void initbtnEdit(final ViewHolder holder, int i){
                ...
                btnValid.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v1) {
                        if(editNom.getText().toString().isEmpty()){
                            ...
                            lesProgrammes.get(position).setNom(editNom.getText().toString());
     ...
     * @param i
     */
    private void initbtnSuppr(final ViewHolder holder, int i){
    ...
    private void inittxtEntite(final ViewHolder holder, int i){
        ...
        holder.txtEntite.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ((ProgrammesActivity)contexte).afficheProgramme(lesProgrammes.get(position));
            }
        });
