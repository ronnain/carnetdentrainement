...
import com.example.romain.carnetdentrainement.vue.ExercicesActivity;


import java.util.ArrayList;


public class Exercice_List_Adapter extends BaseAdapter {
        private ArrayList<Exercice> lesExercices;
        private LayoutInflater inflater;
        private Controle controle;
        private Context contexte;

        public Exercice_List_Adapter(Context contexte, ArrayList<Exercice> lesExercices){
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final Exercice_List_Adapter.ViewHolder holder;
            //si la ligne n'existe pas encore
            if(view == null){
                holder = new Exercice_List_Adapter.ViewHolder();
                ...
                holder = (Exercice_List_Adapter.ViewHolder) view.getTag();
            }
            // valorisation du contenu du holder (donc de la ligne)
            holder.txtEntite.setText(lesExercices.get(i).getNom());
     ...
     * @param i
     */
    private void initbtnEdit(final Exercice_List_Adapter.ViewHolder holder, int i){
                ...
                btnValid.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v1) {
                        if(editNom.getText().toString().isEmpty()){
                            ...
                            lesExercices.get(position).setNom(editNom.getText().toString());
     ...
     * @param i
     */
    private void initbtnSuppr(final Exercice_List_Adapter.ViewHolder holder, int i){
    ...
    private void inittxtEntite(final Exercice_List_Adapter.ViewHolder holder, int i){
        ...
        holder.txtEntite.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ((ExercicesActivity)contexte).afficheSerie(lesExercices.get(position));
            }
        });
